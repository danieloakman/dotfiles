{ pkgs, env, config, ... }: {
  ...
  config = {
    my.ai = {
      # Download this file: https://raw.githubusercontent.com/drona23/claude-token-efficient/refs/heads/main/CLAUDE.md
      rootContext = builtins.readFile (pkgs.fetchurl {
        url = "https://raw.githubusercontent.com/drona23/claude-token-efficient/refs/heads/main/CLAUDE.md";
        sha256 = "1blq3msgkdjcqwcn5d73jy8phv1z1ayx190cgr0rcdg9pygpcjv9";
      });
      skills = {
        "ui-design-brain".source = pkgs.fetchFromGitHub {
          owner = "carmahhawwari";
