...
# https://herdr.dev
# Optional phone PWA: https://github.com/AltanS/collie
{ env
, config
, lib
, pkgs
...
let
  ...
  herdrPackage = if env.platform == "darwin" then herdrDarwin else pkgs.herdr;
...
in
{
  options.my.programs.herdr = {
    ...
    collie = {
      ...
      port = lib.mkOption {
        type = lib.types.port;
        # Avoid 8787 (headroom) and 15732 (opencode web).
        default = 15734;
